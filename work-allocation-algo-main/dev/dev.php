...
<body>
	...
	<main>
		<div class="ticket-tab">
			<div class="ticket-tab__progress">Assigned <span class="ticket-tab__progress-value">
				...
				?>
						<div class="ticket">
							...
							if ($row['ticket_status'] < 3) {
								?>
								<a class="ticket__update" href="dev.php?ticket_id=<?php echo $row['ticket_id']; ?>&amp;did=<?php echo $dev_id; ?>&amp;dname=<?php echo $dev_name; ?>">Update</a><?php
							}
							?>
						</div>	
				<?php
